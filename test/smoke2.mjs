...
try {
  ...
  await p1.screenshot({ path: SS('smoke2-scroll.png') });
  ...
  await p1.screenshot({ path: SS('smoke2-voice.png') });
  await p1.click('#drawer-close');

  await p1.screenshot({ path: SS('smoke2-final-alice.png') });
  await p2.screenshot({ path: SS('smoke2-final-bob.png') });
